...
export default async function HomePage() {
  // primaryTask is the first ENABLED + NON-HIDDEN task (→ sbm for this site).
  ...
  return (
    <EditableSiteShell>
      <main>
        ...
        <div className="mx-auto max-w-[var(--editable-container)] px-4 sm:px-8 lg:px-[4.5rem]">
          <Ads slot="header" showLabel eager className="mx-auto my-4 w-full" />
        </div>
