export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'solospiv',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Solospiv',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'solospiv.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://solospiv.com',
